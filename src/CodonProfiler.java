...
public class CodonProfiler {
	...
	/**
	 * Count how many times each codon in an array of codons occurs in a strand of
	 * DNA. Return int[] such that int[k] is number of occurrences of codons[k] in
	 * strand. Strand codons can start at all valid indexes that are multiples of 3:
	 * 0, 3, 6, 9, 12, ...
	 * 
